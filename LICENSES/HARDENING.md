# License hardening checklist (do this before first public GitHub push)
...
3) Add a clear separation statement in README
- Spec/docs are CC BY 4.0
- Code/tooling is Apache 2.0
- Trademarks are governed by TRADEMARKS.md
